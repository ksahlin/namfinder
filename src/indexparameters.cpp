 ...
 */
//IndexParameters IndexParameters::from_read_length(int read_length, int k, int s, int l, int u, int max_seed_len, int filter_cutoff) {
...
//    }
//    return IndexParameters(canonical_read_length, k, s, l, u, max_dist, filter_cutoff);
//}
